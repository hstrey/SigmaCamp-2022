...
# ╔═╡ 494f6002-1c45-11ed-15aa-450363d50916
begin
...
# ╔═╡ 2c15d68b-df14-4676-920a-c04d9c311257
begin
	@variables t x(t)
	@parameters λ
	D = Differential(t)
...
# ╔═╡ f1b55f87-3651-4aaa-87f6-3457b19001e5
eqs = [D(x) ~ -λ*x]

# ╔═╡ e3005b97-dddd-46f2-b5a4-114828a51c7e
u₀ = [x => 1.0]

# ╔═╡ 7dd93d0b-228f-400b-a48b-ca507b55c83a
p = [λ => 1.0]

# ╔═╡ 16f8f373-910f-442f-9741-98b117f0e005
@named decay = ODESystem(eqs, t)

# ╔═╡ edfecd5d-6b60-4a16-8794-400a52d923eb
prob = ODEProblem(decay,u₀,(0.0,5.0),p)

# ╔═╡ 6832bf0e-58d2-453e-9722-274c77d5d058
sol = solve(prob, Tsit5())

# ╔═╡ 6813bd86-9ada-43c7-b6fc-e35a57f86852
plot(sol)

# ╔═╡ 81e982e6-1f35-4cfe-acec-3e894e770d59
@variables v(t)

# ╔═╡ 77a328af-e761-448d-bf7c-1f97f744e5c8
@parameters k

# ╔═╡ 2df1daf7-68f1-439b-a22d-fb66e075867e
eqs2 = [D(x) ~ v, D(v) ~ -k*x]

# ╔═╡ ba64b75b-d895-446f-a79c-d62c0f5b76eb
@named osc = ODESystem(eqs2, t)

# ╔═╡ ccab4be8-4713-4844-8cf8-8c9f38632326
u1 = [x => 1.0, v => 0.0]

# ╔═╡ 3359c3b7-5dbb-4e96-ad25-e5ee6ec0e230
p1 = [ k => 1.0]

# ╔═╡ f3973f10-53e6-4416-92dd-1b458236fd3a
prob2 = ODEProblem(osc,u1,(0.0,20.0),p1)

# ╔═╡ 0cea15de-bbf4-4fbe-8c5f-f3402242e1d5
sol2 = solve(prob2, Tsit5())

# ╔═╡ 9f945903-24ee-4b81-a201-5da6183fb290
plot(sol2)
