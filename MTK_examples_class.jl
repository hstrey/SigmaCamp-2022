...
# ╔═╡ ba9a3eea-1cc8-11ed-2810-bbefcc1ecd8d
begin
...
# ╔═╡ fb4efda5-d114-436b-9f1c-e7c6f06cb8fb
@variables t x(t)

# ╔═╡ 94357591-0fd9-4325-b70e-77d9c492cfc7
@parameters λ

# ╔═╡ d8504204-25ba-473a-a3c4-d5b1761050aa
D = Differential(t)

# ╔═╡ 46804969-fe30-4f7d-b288-cec193bbadc3
eqs = [D(x) ~ -λ*x]

# ╔═╡ 8960a5bf-e18d-4c07-9ffd-d91a704faf07
@named decay = ODESystem(eqs,t)

# ╔═╡ 6fd816e1-9631-46cc-add6-a0a1b4d3ed03
u₀ = [x => 1.0]

# ╔═╡ ff83466a-605a-4f67-aef3-0135288f7e33
p = [λ => 1.0]

# ╔═╡ 8ef90b6d-4ed5-41b9-bbe1-f44e42a35d5e
tspan = (0.0,5.0)

# ╔═╡ 2d7e3387-9888-4682-b9f2-7d4a5cdc3a5f
prob = ODEProblem(decay,u₀,tspan,p)

# ╔═╡ 812db91c-e7c6-4f92-9c00-bda5993cbfb1
sol = solve(prob,Tsit5())

# ╔═╡ 1ac780fc-23a6-445b-96f3-41136de8e22d
plot(sol)

# ╔═╡ fdc8c344-51a1-4f9d-8c15-1b2ae425c2af
md"""
λ
$(@bind lambda html"<input type=range min=0.1 max=3 step=0.05>")
"""

# ╔═╡ 3f71ff1d-8bfa-4729-85f0-63e7df0bfbca
p2 = [lambda]

# ╔═╡ 1b1027d6-636b-493d-95c0-b47ff30f7953
prob2 = remake(prob,p=p2)

# ╔═╡ a46bc973-691f-494e-ac5c-ec473665fb05
sol2 = solve(prob2,Tsit5())

# ╔═╡ 496348f6-82e3-4c9c-8e76-83ec4821d3f5
plot(sol2)

# ╔═╡ 792ccfec-c37d-409a-9d43-770ba5cfc127


# ╔═╡ cf54c7e3-5288-4e00-8814-ee1bea9b3c29
lambda

# ╔═╡ 73265fe5-8c6f-4723-a721-e1cb7305fee0
@variables v(t)

# ╔═╡ 073fcc2c-c034-46c4-89c5-3738b1a2e188
@parameters k

# ╔═╡ d38b514e-a5ec-4ba1-966f-ef43c34d26fe
eqs2 = [ D(x) ~ v, D(v) ~ -k*x]

# ╔═╡ 63adafc6-d576-4c3a-a744-5c748e0144f0
@named osc = ODESystem(eqs2,t)

# ╔═╡ eb85ccad-f4d6-44db-a3f8-61b57b7faca9
u2 = [x => 1.0, v => 0.0]

# ╔═╡ 24fa14c1-507e-4f8d-b55e-0da9ed09e791
po = [k => 1.0]

# ╔═╡ 55ba7d8a-d53f-49b1-98a6-1da497b1f935
prob_osc = ODEProblem(osc,u2,(0,20.0),po)

# ╔═╡ e8f9a857-b613-4ee9-9c95-b39d9fce27be
sol_osc = solve(prob_osc, Tsit5())

# ╔═╡ a659cf6e-219d-424a-8e5f-11b2c5cabad1
plot(sol_osc)
...
git-tree-sha1 = "4db2755e968c9fe905a2566147ebd037d72f91a6"
