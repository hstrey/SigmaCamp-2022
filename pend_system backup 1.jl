...
# ╔═╡ 2c5d4f2d-cbc5-4ab6-bf32-2555ca7cffcf
pend1_low = ode_order_lowering(pend1)

# ╔═╡ 044b2174-d4cd-44fc-ba57-312e1526e846
sys = [pend1_low]

# ╔═╡ 57a55c6c-7db0-409e-80ce-95aff982bf7f
eqs = [pend1_low.xc ~ 0.0, pend1_low.yc ~ 0.0]

# ╔═╡ b30fb032-91d6-49bd-b65f-545f70abec97
@named pend_single = ODESystem(eqs, systems=sys)

# ╔═╡ ff8ec1ea-03e5-46b2-9e5e-7c7feeda6b60
pend_simple = structural_simplify(pend_single)
