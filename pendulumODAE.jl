...
# ╔═╡ de3b873c-1cfd-11ed-3564-69b2a48eca13
begin
...
# ╔═╡ 2d340c71-3d8a-4ccf-b9d2-c472d8bde174
@variables t x(t) y(t) vx(t) vy(t) T(t)

# ╔═╡ 4704bb37-d4dd-4010-9e87-ae0497eb634e
@parameters l g

# ╔═╡ f1fa7e41-7fb3-4c9e-a3f8-8c2a6ff33af0
D = Differential(t)

# ╔═╡ f9254380-c7f1-4845-9dd1-f96ae9b5d99a
eqs = [D(x) ~ vx,
	   D(vx) ~ T*x,
	   D(y) ~ vy,
	   D(vy) ~ T*y - g,
	   0 ~ 2*(vx^2 + vy^2 + T/l*x^2 +y*(T/l*y-g))]

# ╔═╡ 1eff2da5-ee9b-4905-aa29-ed2c652efa1f
@named pend = ODESystem(eqs, t)

# ╔═╡ f0fa5276-b678-489d-9273-70244c4a3217
states(pend)

# ╔═╡ a896afcd-86cc-42c5-aad5-6e4d15ce9350
u0 = [x=>1.0, y=>0.0, vx=>0.0, vy=>0.0]

# ╔═╡ fc161521-1d5b-4ee3-836b-8a47f66c349e
tspan = (0,20.0)

# ╔═╡ 4b0e6cf6-896f-4c8e-aab5-414f3372fb21
p = [l=>1.0, g=>9.81]

# ╔═╡ fae87292-4c7a-4075-9357-76623ebd8485
prob = ODAEProblem(pend,u0,tspan,p)

# ╔═╡ fda65b12-ff26-430b-8da9-77fd4f8bcac5
sol = solve(prob, Tsit5())

# ╔═╡ ea92cbf2-e105-4b79-ab35-af3d8449993b
plot(sol)

# ╔═╡ 8c81287d-ae58-4411-ae2f-d447a3dbe355
eqs2 = [D(D(x)) ~ T * x,
    D(D(y)) ~ T * y - g,
    0 ~ x^2 + y^2 - l^2]

# ╔═╡ c861789e-1fc5-4c17-8ff9-205a22086ff8
pendulum2 = ODESystem(eqs2, t, [x, y, T], [l, g], name = :pendulum)

# ╔═╡ 8229b151-3024-4db3-880f-fcc182c8b35b
first_order_sys = ModelingToolkit.ode_order_lowering(pendulum2)

# ╔═╡ 9c320a9f-deab-446e-a791-432c8867323c
new_sys = dae_index_lowering(first_order_sys)

# ╔═╡ e4a0ad4e-e480-4041-af09-6f9c93f82764
string(states(new_sys))

# ╔═╡ 4911d1c6-8dc9-46e1-8bd6-560c276a698c
@variables xˍt(t) yˍt(t)

# ╔═╡ a9b3b82a-732f-48af-94a2-e84ace089e04
u1 = [x => 1.0, y => 0.0, xˍt => 0.0, yˍt =>0.0]

# ╔═╡ d63d6dbb-5f7c-4ceb-9b19-a3bca8e74d88
u2 = [0.0,0.0,1.0,0.0]

# ╔═╡ a7d2b994-df86-4f6a-b710-dbf6be2b6356
prob2 = ODAEProblem(new_sys,u2,tspan,p)

# ╔═╡ 7366bd44-eee7-467c-bb9b-4f8c84b83940
sol2 = solve(prob2, Tsit5())

# ╔═╡ 884c7894-98f1-4fdc-9254-d914c7baf157
plot(sol2)
